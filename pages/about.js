...
export default function About() {
	return (
		<>
			<article>
				<p>张爱玲把她的随笔集子叫作《流言》，取意“水上写的字”，不求持久，但求传得快。这当中自然有文人自谦自嘲的成分，但另外一层意思似乎是：我就随便写写，你别太当真，尤其不要作为把柄日后拿来打我的脸是最好的。更不要说，在一个不能随便发表言论的社会，“说错话”的后果可能远比打脸要严重得多。所以我的这个标题和这些看似多余的“免责声明”透露出的是浓浓的求生欲。</p>
