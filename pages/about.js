	...
	return (
		<>
			<article>
				...
				<p>还有另一个有点难为情的理由——我有个小名叫作“胡闹”，儿时每当有人要拿长辈的口气训斥我时总会说：“真是胡闹！”。这句一语双关的幽默以及它引发的旁观者的哄笑，至今回想起来仍心有戚戚焉。这对我的人生多少造成了一些困扰，以致于时至今日，每当我认为自己在做一些不着边际的事，或是抱有一些不切实际的想法时，耳边总能响起它。</p>
