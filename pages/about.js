...
export default function About() {
	return (
		<>
			<article>
				<p>张爱玲把她的随笔集子叫作《流言》，取意“水上写的字”，不求持久，但求传得快。这其中固然有文人自谦的成分，但另外一层意思似乎是说：我就随便写写，你别太当真，尤其不要日后拿它们作为把柄来打我的脸是最好的，用今天的话来说这叫作“求生欲”。然而在一个不能自由发表言论的社会，说错话的后果可能远比被打脸要严重得多。《茶馆》里的王利发，把“莫谈国事”四个大字做成的告示贴出来，做了一番自我阉割，最后还是免不了要挨刀。所以尽管可能显得多余，我还是写下以上的声明，来解释一下我为本站命名的初衷。</p>
